...
# current_file_data_save = '//nfs/bisp_data_server/Linfang/PF_recon/PF55/SS/NYU_brain_new/'
current_file_data_save = '//media/bisp/New Volume/Linfang/PF_CC398_218_170_218/PF55/EMS/CC_brain_testing_code/'
...
EMS_flag =1
# for validation
# filePath ='///nfs/bisp_data_server/Linfang/PF_recon/singlecoil//validation/'
...
##############################################################
    ...
    # imgR = np.real(img)/scale_ref
    # imgI = np.imag(img)/scale_ref
    img = img/scale_ref
...
########################### 
    ...
    # plt.savefig('img_data_zero') 

    # plt.figure(2)
    # plt.imshow((np.angle(img_data[90,0, :, :])), cmap='gray')
    # plt.savefig('angle_data_zero') 
...
# # for train
print('train')
# filePath ='///nfs/bisp_data_server/Linfang/PF_recon/singlecoil//train/'
